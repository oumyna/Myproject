                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="type_examen" value="{{ $examen->type_examen }}" required class="form-control" placeholder="Entrez le type d'examen">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="lieu" value="{{ $examen->lieu }}" required class="form-control" placeholder="Entrez le lieu">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <input type="date" name="date" value="{{ $examen->date }}" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <input type="time" name="heure" value="{{ $examen->heure }}" required class="form-control">
                            </div>
                        </div>
